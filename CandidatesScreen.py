...
class Ui_CandidatesScreen(object):
    def setupUi(self, CandidatesScreen):
        ...
        self.victor_profile_button.setGeometry(QtCore.QRect(280, 30, 251, 51))
        font = QtGui.QFont()
        ...
        self.don_profile_button.setGeometry(QtCore.QRect(280, 220, 251, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.nigil_profile_button.setGeometry(QtCore.QRect(280, 410, 251, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton.setGeometry(QtCore.QRect(690, 500, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, CandidatesScreen):
        ...
        self.pushButton.setText(_translate("CandidatesScreen", "HOME"))
